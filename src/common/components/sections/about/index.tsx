          ...
          <div className="antialiased group relative w-full">
            <div className="text-md relative z-40 flex flex-col gap-3 font-semibold tracking-wide text-primary lg:absolute lg:right-0 lg:top-[27%] lg:block lg:max-w-[580px] lg:text-start lg:text-lg xl:top-1/3 xl:h-[442px] xl:max-w-[650px]">
              <div className="flex h-full flex-col justify-center gap-6">
                <span>
                  I&apos;m Software developer working for NASA with expertise in SDLC,
                  Agile & Python programming. Proven ability to deliver user-centered
                  applications with a focus on intuitive command following and user
                  interaction.
                </span>
                <span>
                  Seeking for software engineering and data science opportunities where I can leverage
                ...
                <p className="flex flex-col items-start sm:items-center lg:items-start">
                  ...
                  >
                    <span className="bg-lightBlue text-2xl font-bold uppercase dark:bg-darkBlue lg:normal-case">
                      Contact me!
                    </span>
                  </Link>
                </p>
            ...
            <div className="absolute z-30 hidden lg:left-0 lg:top-1/4 lg:block">
              <div className="relative h-72 w-72 lg:h-[380px] lg:w-[380px] xl:h-[470px] xl:w-[470px]">
                <div className="absolute inset-0 z-20 rounded-full bg-gradient-to-b from-lightBlue via-blue-500 to-blue-600 transition-opacity group-hover:opacity-30" />
