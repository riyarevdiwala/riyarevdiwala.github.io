        ...
        <div className="container flex flex-col items-start justify-center tracking-wide text-white">
          <div className="container relative flex h-full w-full flex-col items-center">
            <div className="h-72 w-[280px] text-center text-[2rem] font-extrabold sm:w-[520px] md:w-[700px] lg:mb-5 lg:w-[920px] lg:text-[3rem]">
              ...
              <br />
              <TextAnimation delay={1} baseText={`I'm Riya Revdiwala`} />
            </div>
            <motion.div
            ...
            >
              <a
                className="group flex w-64 cursor-pointer items-center justify-center gap-2 rounded-full bg-darkBg px-7 py-3 text-white outline-none transition hover:bg-lightBlue hover:text-black hover:dark:text-black sm:w-auto"
                href="mailto:riyarevdiwalaa@gmail.com"
              >
