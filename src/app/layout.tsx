...
export const metadata: Metadata = {
  title: 'Riya Revdiwala | Portfolio',
  description:
    'Check out modern and stylish portfolio of an experienced Software Engineer Riya Revdiwala! Built using TypeScript, Next.js 14, Framer Motion and Tailwind CSS.',
};
